...
export const ROTATION_PRESETS: Record<string, number> = {
  subtle: 45,
  normal: 90,
  strong: 180,
};
...
export const VALID_DIRECTIONS = new Set<string>([
  'up',
  'down',
  'left',
  'right',
...
export const VALID_INTENSITIES = new Set<string>(
  Object.keys(INTENSITY_PRESETS),
);

export function resolveIntensity(value: string | number): number {
...
export function intensityToRotate(value: string | number): number {
